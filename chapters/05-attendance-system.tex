...
Študent príde na vyučovanie a priloží ISIC kartu k NFC čítačke v učebni. Zariadenie načíta identifikátor karty a vytvorí udalosť dochádzky obsahujúcu UID karty a časovú pečiatku v UTC+0 (podrobnosti o formáte časovej pečiatky sú uvedené pri popise dátového modelu, entita Attendance).
