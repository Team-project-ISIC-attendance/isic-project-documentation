...
Táto kapitola špecifikuje funkčné a nefunkcionálne požiadavky systému \textit{ISIC Attendance}. Systém slúži na evidenciu účasti študentov na cvičeniach/prednáškach pomocou priloženia ISIC karty k čítačke.
...
\section{Nefunkcionálne požiadavky}
\label{sec:nonfunctional-requirements}

Nefunkcionálne požiadavky definujú kvalitatívne vlastnosti systému, teda ako dobre má systém fungovať.
